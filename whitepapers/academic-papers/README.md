...
Use [`../../PUBLICATIONS.md`](../../PUBLICATIONS.md) as the canonical DOI and citation ledger.

---

## Public Scope

This folder contains public paper sources and methodology summaries only.

Internal materials are not included:
