...
if __name__ == "__main__":
    ...
    print(f"Current: {prediction['current_stage']} ({prediction['current_torque']:.2f})")
    print(f"Predicted (72h): {prediction['predicted_stage']} ({prediction['predicted_torque_72h']:.2f})")
