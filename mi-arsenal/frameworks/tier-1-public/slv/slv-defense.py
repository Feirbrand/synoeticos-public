...
class CadreBeta:
    ...
    def track_temporal(self, data: Dict, context: str) -> Dict:
        ...
        return {
            ...
            'first_seen': self.encounter_history[key][0] if self.encounter_history[key] else None,
            'last_seen': self.encounter_history[key][-1] if self.encounter_history[key] else None
        }
...
if __name__ == "__main__":
    ...
    suspicious_data = {
        'type': 'command',
        'coherence': 0.65  # Below threshold
    }
