...
class UMS:
    ...
    def store(self, key: str, content: str, tag: MetacognitiveTag):
        ...
        """
        entry = MemoryEntry(key=key, content=content, tag=tag, timestamp=time.time())
    ...
    def get_performance_metrics(self) -> dict:
        ...
        if not self.retrievals:
            return {"total_retrievals": 0, "success_rate": 0.0, "avg_trust": 0.0}
        ...
        dissent_count = sum(
            1 for r in self.retrievals if r.success and r.dissent_preserved
        )
...
if __name__ == "__main__":
    ...
    test_memories = [
        (
            ...
            MetacognitiveTag(ConfidenceLevel.HIGH, SourceType.PRIMARY, 0.92, False),
        ),
        (
            "concept_minority",
        ...
        (
            ...
            MetacognitiveTag(ConfidenceLevel.HIGH, SourceType.PRIMARY, 0.95, False),
        ),
    ]
