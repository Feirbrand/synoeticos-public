...
class MjolnirStrike:
    ...
    def _venom_cadence_sequence(
        self, target: ThreatTarget, killchain: KillchainType
    ) -> StrikeResult:
        """
        ...
        # Overall success
        success = burn_success and bind_accuracy > 0.99 and purge_accuracy > 0.99
