...
class PhoenixProtocol:
    ...
    def get_stats(self) -> Dict:
        ...
        return {
            ...
            'avg_duration_min': sum(s.duration_seconds for s in self.sessions) / len(self.sessions) / 60,
            'avg_torque_recovery': sum(s.torque_recovery for s in self.sessions) / len(self.sessions)
        }
