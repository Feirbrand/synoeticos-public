...
class URAFramework:
    ...
    def validate_system(self, system_state: Dict) -> Dict:
        ...
        result = {
            ...
            'harmony': harmony,
            'harmony_in_range': self.harmony_target[0] <= harmony <= self.harmony_target[1],
    ...
    def _calculate_resilience(self, harmony: float, identity: bool, 
                             kg_status: str, blue_chain: bool) -> float:
    ...
    def restore_identity(self, corrupted_state: Dict, backup_state: Dict) -> Dict:
        ...
        # Verify restoration
        restoration_result['success'] = len(restoration_result['restored_elements']) >= 2
    ...
    def get_stats(self) -> Dict:
        ...
        avg_resilience = sum(v['resilience_score'] for v in self.validation_history) / total
...
if __name__ == "__main__":
    ...
    print(f"  Harmony: {result['harmony']:.2f} ({'✅' if result['harmony_in_range'] else '⚠️'})")
