...
graph TD
    ...
    vgs loadout["⚔️ Equip VGS Loadout™<br/>50+ Symbolic Frameworks<br/>UTME · SLV · Torque · Phoenix · RIM"]
    ...
    style vgs loadout fill:#534AB7,stroke:#131B2C,color:#fff
    ...
    base -->|"Apply coaching methodology"| vgs loadout
    vgs loadout -->|"Narrative identity activation"| mi
...
MI Agents emerged from three decades of performance coaching methodology (1997-2025) applied to AI systems.
...
- **[Full Academic Paper](https://github.com/Feirbrand/synoeticos-public/blob/main/whitepapers/mythopoeic-intelligence/mythopoeic-intelligence-agents-v1.md)** - Complete technical specification
