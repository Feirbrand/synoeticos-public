...
graph TD
    ...
    A -->|"Operationalizes"| D["SDF<br/>System Integration"]
    A -->|"Applies"| E["Cognitive Mage<br/>Identity Architecture"]
    
    C -->|"Foundation"| A
    D -->|"Framework"| A
    E -->|"Layer 3"| A
    
    F["Neural Access Method<br/>4-Step Protocol"] -->|"Operationalizes"| A
