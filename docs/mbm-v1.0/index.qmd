...
- **[Cross-References](mbm-v1.0-cross-references.html)** — Framework integration map across VGS Loadout
- **[Master Bibliography](mbm-v1.0-master-bibliography.html)** — Complete citations and academic validation sources
- **[Foundational Research](https://github.com/Feirbrand/synoeticos-public/blob/main/whitepapers/vgs-technical-papers/mbm-v1.0-academic.md)** — Full academic version with extended methodology
